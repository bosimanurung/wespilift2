...
def new_calc_straight(): # from new_calc.py (in there, is counting Vogel)
    ...
    _sgfluid = (st.session_state._wc/100) * st.session_state._sgw + (1-(st.session_state._wc/100)) * st.session_state.kg
    ...
    _Rs=st.session_state._sgg*(( (_pip/18) * (10**(0.0125*st.session_state.lbs - 0.00091*st.session_state._bht)) )**1.2048)
    ...
    _Bo = 0.972+0.000147*((_Rs * (st.session_state._sgg/st.session_state.kg)**0.5 + 1.25 * st.session_state._bht) ** 1.175)
    # Vo=(1-WC)*Qdes*Bo;
   ...
   # Bg=5.04*0.85*(BHT+460)/(PIP+14.7) -> yg benar kurung nya sprti di bawah
    ...
    _composite_sg = ( ( (1-(st.session_state._wc/100))*st.session_state._qdes*st.session_state.kg + (st.session_state._wc/100)*st.session_state._qdes*st.session_state._sgw) * 62.4*5.6146 + st.session_state._producing_gor*(1-(st.session_state._wc/100))*st.session_state._qdes*st.session_state._sgg*0.0752) / (_Vt*5.6146*62.4)
    ...
    new_records = [[st.session_state["new_id_calc"], st.session_state._user_id, st.session_state._well_name, \
                    st.session_state._field_name, st.session_state._company, st.session_state._engineer, \
                        st.session_state._date_calc, st.session_state._id_instrument, st.session_state._id_calc_method, \
                        st.session_state._id_welltype, st.session_state._id_measurement, st.session_state._comment_or_info, \
                        st.session_state._top_perfo_tvd, st.session_state._top_perfo_md, st.session_state._bottom_perfo_tvd, \
                        st.session_state._bottom_perfo_md, st.session_state._qtest, st.session_state._sfl, st.session_state._smgFreeGasAtQtest, \
                        st.session_state._sbhp, st.session_state._fbhp, st.session_state._producing_gor, st.session_state._wc, \
                        st.session_state._bht, st.session_state._sgw, st.session_state._sgg, st.session_state._qdes, \
                        st.session_state._psd, st.session_state._whp, st.session_state._psd_md, st.session_state._p_casing, \
                        st.session_state._pb, st.session_state.lbs, st.session_state.kg, st.session_state._id_casing_size, \
